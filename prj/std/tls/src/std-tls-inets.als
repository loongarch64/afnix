...
const AFNIX:TLS:INETS:H-UCO-MSG "    [H]              set the host address"
const AFNIX:TLS:INETS:P-UCO-MSG "    [P]              set the host port"
...
trans afnix:tls:inets:preini (argv) {
  ...
  this:opts:add-string-option 'P' AFNIX:TLS:INETS:P-UCO-MSG
  this:opts:add-string-option 'H' AFNIX:TLS:INETS:H-UCO-MSG
...
trans afnix:tls:inets:read-loop (is) {
...
trans afnix:tls:inets:write-loop (os) {
