// ---------------------------------------------------------------------------
// - Rvector2.hpp                                                            -
// - afnix:mth module - real vector 2 definitions                            -
// ---------------------------------------------------------------------------
...
namespace afnix {
  ...
  /// The Rvector2 class is a 2 dimensional vector class for the afnix math
  /// module. A 2 dimensional vector is defined by its (x,y) components in
